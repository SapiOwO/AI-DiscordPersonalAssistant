...
OLLAMA_MODEL: str = get_env_var("OLLAMA_MODEL", "llama3")
OLLAMA_TIMEOUT: float = get_float_env_var("OLLAMA_TIMEOUT", 120.0)

MODEL_SUPPORTS_VISION: bool = get_bool_env_var("MODEL_SUPPORTS_VISION", False)
MODEL_SUPPORTS_THINKING: bool = get_bool_env_var("MODEL_SUPPORTS_THINKING", False)
MODEL_SUPPORTS_WEBSEARCH: bool = get_bool_env_var("MODEL_SUPPORTS_WEBSEARCH", False)
...
OLLAMA_NUM_CTX: int = get_int_env_var("OLLAMA_NUM_CTX", 2048)
...
INACTIVITY_TIMEOUT: int = get_int_env_var("INACTIVITY_TIMEOUT", 300)
